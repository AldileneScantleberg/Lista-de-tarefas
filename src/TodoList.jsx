...
import './TodoList.css';
import Icone from './assets/icon-tarefas.webp';
                ...
                <div style={{textAlign: 'center'}}>
                    {
                        ...
                        :  
                        lista.map((intem, index) =>(
                        <div key ={index} className={intem.isCompleted ? "item completo" : "item"}>
                            <span onClick={()=>{clicou(index)}}>{intem.text}</span>
